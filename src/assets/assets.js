...
import hotelHostGoldPremium from "./hotelHostGoldPremium.png";
...
export const testimonials = [
  {
    ...
    rating: 5,
    review:
      "I've used many booking platforms before, but none compare to the personalized experience and attention to detail that SilverLeaf provides.",
  },
  {
    id: 2,
    name: "Liam Johnson",
    ...
    rating: 4,
    review:
      "SilverLeaf exceeded my expectations. The booking process was seamless, and the hotels were absolutely top-notch. Highly recommended!",
  },
  {
    id: 3,
    name: "Sophia Lee",
    ...
    rating: 5,
    review:
      "Amazing service! I always find the best luxury accommodations through SilverLeaf. Their recommendations never disappoint!",
  },
];
